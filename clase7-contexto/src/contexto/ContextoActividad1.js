...
export const ContextoActividad1 = createContext();

export const DatosActividad1 = ({ children }) => {
    const arrayValores = [{
    ...
    const [valor, setValor] = useState(arrayValores);
    return (
        <ContextoActividad1.Provider value={{valor, setValor}}>
            { children }
        </ContextoActividad1.Provider>
    )
};